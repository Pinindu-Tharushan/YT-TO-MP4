...
\033[1;32m   \   /    | |       | | | |  | |  | |\/| |  ___/__   _|
\033[1;33m    | |     | |       | | | |__| |  | |  | | |      | |  
\033[1;32m    |_|     |_|       |_|  \____/   |_|  |_|_|      |_|\033[1;91mv1.7
...
print()
print('''echo -e \e[96m[1] සිංහල ''')
print('''echo -e \e[96m[2] English ''')
print()
...
def sinhala():
    ...
    print()
    print('''echo -e \e[44m\e[7mnano sinhala.txt''')
    print()
...
def english():
    ...
    print()
    print('''echo -e \e[44m\e[7mnano english.txt''')
    print()
